...
public class QuestionController {
    ...
    public ResponseEntity<Question> getQuestionById(@PathVariable Integer id) throws ChangeSetPersister.NotFoundException {
    ...
    public ResponseEntity<Question> updateQuestion(
            @PathVariable Integer id, @RequestBody Question question) throws ChangeSetPersister.NotFoundException {
